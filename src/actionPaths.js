const ActionPaths = {
  ...
  'state-delete': 'https://23294-aioappstash-dev1.adobeioruntime.net/api/v1/web/aioappstash-0.0.1/state-delete',
  'state-list': 'https://23294-aioappstash-dev1.adobeioruntime.net/api/v1/web/aioappstash-0.0.1/state-list',
  'state-put': 'https://23294-aioappstash-dev1.adobeioruntime.net/api/v1/web/aioappstash-0.0.1/state-put'
}

module.exports = ActionPaths
